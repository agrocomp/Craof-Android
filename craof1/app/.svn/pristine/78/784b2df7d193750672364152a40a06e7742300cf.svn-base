...
public class AplicacaoInsumoVisualizar extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aplicacaoinsumo_visualizar);
        ...
        btAplicacaoInsumoVisualizarVoltar = (Button) findViewById(R.id.btAplicacaoInsumoVisualizarVoltar);
