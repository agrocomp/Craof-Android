 ...
 * @author Luan
 */
public class PanelDestinoBuscar extends javax.swing.JPanel {

    /**
     * Creates new form PanelLocalBuscar
     */
    public PanelDestinoBuscar(JFrame frame) {
        initComponents();
        this.frame = frame;
        inicializar();
    }
    ...
    private void inicializar() {
        ...
        listaLocalDestino = new ArrayList();
        usuario = new Usuario();
        localDestino = new LocalDestino();
        usuario.setId(1);
        localDestino.setDescricao(wtNome.getText().toString().toUpperCase());
        try {
            listaLocalDestino = controle.buscarTodos(localDestino, usuario);
            System.out.println(listaLocalDestino.size());
            DefaultTableModel model = (DefaultTableModel) wtblocal.getModel();
            model.getDataVector().removeAllElements();
            for (LocalDestino aux : listaLocalDestino) {
                model.addRow(new Object[]{aux.getId_localDestino(), aux.getDescricao()});
            }
    ...
    private void initComponents() {
        ...
        wtblocal.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(wtNome, javax.swing.GroupLayout.PREFERRED_SIZE, 294, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(buscar))
                                    .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addComponent(wtCodigo, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void selecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selecionarActionPerformed
        if (wtblocal.getSelectedRow() > -1) {
            if (frame instanceof SegundaTela) {
                ...
                wtNome.setText(listaLocalDestino.get(wtblocal.getSelectedRow()).getDescricao());
                ...
                if (line >= 0) {
                    if (c.getPanel() instanceof DestinoProdutos) {
                        LocalDestino localDestino = new LocalDestino();
                        localDestino.setId_localDestino((Integer) wtblocal.getValueAt(line, 0));
                        localDestino.setDescricao((String) wtblocal.getValueAt(line, 1));
            ...
            JOptionPane.showMessageDialog(null, "ERROR CRAOFx05 : Selecionar uma linha da tabela.");
        }
        ...
        try {
            ...
            if (listaLocalDestino.size() == 0) {
                ...
                if (n == 0) {
                    ...
                    usuario = new Usuario();
                    localDestino = new LocalDestino();
                    localDestino.setDescricao(wtNome.getText());
                    ...
                    try {
                        ...
                        if (cadastrou == 0) {
                            localDestino.setId_localDestino(Integer.parseInt(controle.maximoId()));
                            JOptionPane.showMessageDialog(null, "Cadastro feito com sucesso");
                            DefaultTableModel model = (DefaultTableModel) wtblocal.getModel();
                            listaLocalDestino.add(localDestino);
                            for (LocalDestino aux : listaLocalDestino) {
                                model.addRow(new Object[]{aux.getId_localDestino(), aux.getDescricao()});
                            }
                        } else if (cadastrou == 1) {
    ...
    private void alterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alterarActionPerformed
        try {
            if (!controle.alterar(listaLocalDestino.get(wtblocal.getSelectedRow()), wtNome.getText().toString())) {
    ...
    private ArrayList<LocalDestino> listaLocalDestino;
}
