 ...
 * @author Luan
 */
public class InsumoMenu extends javax.swing.JPanel {

    /**
     * Creates new form CulturaMenu
     */
    public InsumoMenu(SegundaTela segundaTela) {
        initComponents();
    ...
    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
        try {
            segundaTela.setTela(new PanelInsumoCadastrar(segundaTela));
        } catch (SQLException ex) {
            Logger.getLogger(InsumoMenu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_cadastrarActionPerformed

    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        segundaTela.setTela(new PanelInsumoBuscar(segundaTela));
