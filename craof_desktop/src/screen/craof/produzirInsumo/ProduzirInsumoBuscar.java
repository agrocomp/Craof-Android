 ...
 * @author Luan
 */
public class ProduzirInsumoBuscar extends javax.swing.JPanel {
    ...
    public ProduzirInsumoBuscar(SegundaTela segundaTela) {
        initComponents();
    ...
    public void inicializar() {
        ...
        listaProducaoInsumos = new ArrayList();
        try {
            listaProducaoInsumos = controle.obterTodosRelatorio();
            DefaultTableModel model = (DefaultTableModel) wtbRelatorio.getModel();
            model.getDataVector().removeAllElements();
            for (ProducaoInsumo aux : listaProducaoInsumos) {
                produtosUtilizados = "";
                for (Insumo i : aux.getInsumo().getListaInsumo()) {
                    produtosUtilizados += i.getDescricao() + ", \n";
                }
                model.addRow(new Object[]{aux.getId_producaoInsumo(), aux.getData(), aux.getInsumo().getDescricao(), aux.getQuantidade(), produtosUtilizados});
            }
    ...
    private void initComponents() {
        ...
        wtbRelatorio.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data", "Insumo", "Quantidade", "Produtos Utilizados"
            }
        ) {
        ...
        wlRelatorio.setText("RELATÓRIO DE PRODUÇÃO DE INSUMOS");
    ...
    private void obterRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_obterRelatorioActionPerformed
        ...
        listaProducaoInsumos = new ArrayList();
        try {
            listaProducaoInsumos = controle.obterRelatorio(wtDataInicial.getText().toString(), wtDataFinal.getText().toString());
            System.out.println(listaProducaoInsumos.size());
            DefaultTableModel model = (DefaultTableModel) wtbRelatorio.getModel();
            model.getDataVector().removeAllElements();
            for (ProducaoInsumo aux : listaProducaoInsumos) {
                produtosUtilizados = "";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            c.abrirPanel(new ProduzirInsumo(c), "Inserir Produto de Insumo");
            c.setVisible(true);
    ...
    public void atualizarTabela(ProducaoInsumo producao) {
        DefaultTableModel model = (DefaultTableModel) wtbRelatorio.getModel();
        model.getDataVector().removeAllElements();
        listaProducaoInsumos.add(producao);
        for (ProducaoInsumo aux : listaProducaoInsumos) {
            produtosUtilizados = "";
            for (Insumo i : aux.getInsumo().getListaInsumo()) {
                produtosUtilizados += i.getDescricao() + ", \n";
    ...
    private ArrayList<ProducaoInsumo> listaProducaoInsumos;
}
