 ...
 * @author Luan
 */
public class CulturaMenu extends javax.swing.JPanel {

    /**
     * Creates new form CulturaMenu
     */
    public CulturaMenu(SegundaTela segundaTela) {
        initComponents();
    ...
    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
        try {
            segundaTela.setTela(new PanelCulturaCadastrar(segundaTela));
        } catch (SQLException ex) {
            Logger.getLogger(CulturaMenu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_cadastrarActionPerformed

    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        segundaTela.setTela(new PanelCulturaBuscar(segundaTela));
