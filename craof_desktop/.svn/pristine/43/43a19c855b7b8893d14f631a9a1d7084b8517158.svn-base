...
public class PanelInsumoCadastrar extends javax.swing.JPanel {
     ...
     */
    public PanelInsumoCadastrar(JFrame frame) throws SQLException {
        initComponents();
        this.frame = frame;
        inicializar();
    ...
    private void initComponents() {
        ...
        wl1.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        wl1.setText("Ingredientes");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/craof80.png"))); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(wsingredientes, javax.swing.GroupLayout.PREFERRED_SIZE, 577, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        System.out.println("wtDescricao: " + wtDescricao.getText());
        if (!wtDescricao.getText().equals("")) {
            ...
            insumo.setAlterado(Boolean.FALSE);
            if (!jcSim.isSelected()) {
                try {
            ...
            JOptionPane.showMessageDialog(null, "ERROR CRAOFx05 : Preencher campo de descrição");
        }
...
*/}
    ...
    public void setInsumo(Insumo insumo) {
        this.insumo = insumo;
        wtCodigo.setText(this.insumo.getId_insumo() + 1 + "");
        wtDescricao.setText(this.insumo.getDescricao());
    }
