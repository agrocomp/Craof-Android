...
public class DestinoMenu extends javax.swing.JPanel {
     ...
     */
    public DestinoMenu(SegundaTela segundaTela) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cultura.setText("LOCAL DE DESTINO");
    ...
    private void cadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarActionPerformed
        try {
            segundaTela.setTela(new PanelDestinoCadastrar(segundaTela));
        } catch (SQLException ex) {
            Logger.getLogger(DestinoMenu.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_cadastrarActionPerformed

    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        segundaTela.setTela(new PanelDestinoBuscar(segundaTela));
