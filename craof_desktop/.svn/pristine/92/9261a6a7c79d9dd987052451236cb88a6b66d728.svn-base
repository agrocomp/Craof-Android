 ...
 * @author Luan
 */
public class DestinoProdutosBuscar extends javax.swing.JPanel {

    /**
     * Creates new form ControlePlantioBuscar
     */
    public DestinoProdutosBuscar(SegundaTela segundaTela) {
        initComponents();
    ...
    public void inicializar() {
        ...
        listaDestinoProdutos = new ArrayList();
        try {
            listaDestinoProdutos = controle.obterTodosRelatorio();
            System.out.println(listaDestinoProdutos.size());
            DefaultTableModel model = (DefaultTableModel) wtbRelatorio.getModel();
            model.getDataVector().removeAllElements();
            for (DestinoProduto aux : listaDestinoProdutos) {
                model.addRow(new Object[]{aux.getId_destinoProduto(), aux.getDataColheita(), aux.getCultura().getNome(), aux.getQuantidade(), aux.getLocalPlantio().getDescricao(), aux.getLocalDestino().getDescricao()});
            }
        } catch (ParseException | SQLException ex) {
            Logger.getLogger(DestinoProdutosBuscar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        wtbRelatorio.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data", "Cultura", "Quantidade", "Local de Plantio", "Local de Destino"
            }
        ) {
        ...
        wlRelatorio.setText("RELATÓRIO DE COLHEITA E DESTINO DOS PRODUTOS");
    ...
    private void obterRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_obterRelatorioActionPerformed
        try {
            listaDestinoProdutos = controle.obterRelatorio(wtDataInicial.getText().toString(), wtDataFinal.getText().toString());
            System.out.println(listaDestinoProdutos.size());
            DefaultTableModel model = (DefaultTableModel) wtbRelatorio.getModel();
            model.getDataVector().removeAllElements();
            for (DestinoProduto aux : listaDestinoProdutos) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            c.abrirPanel(new DestinoProdutos(c), "Inserir Destino dos Produtos");
    ...
    public void atualizarTabela(DestinoProduto destino) {
        DefaultTableModel model = (DefaultTableModel) wtbRelatorio.getModel();
        model.getDataVector().removeAllElements();
        listaDestinoProdutos.add(destino);
        for (DestinoProduto aux : listaDestinoProdutos) {
            model.addRow(new Object[]{aux.getId_destinoProduto(), aux.getDataColheita(), aux.getCultura().getNome(), aux.getQuantidade(), aux.getLocalPlantio().getDescricao(), aux.getLocalDestino()});
        }
    }
    ...
    private ArrayList<DestinoProduto> listaDestinoProdutos;
